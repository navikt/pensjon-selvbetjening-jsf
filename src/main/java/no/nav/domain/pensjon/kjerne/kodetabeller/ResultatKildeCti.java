...
//@Entity
//@Immutable
//@Table(name = "T_K_RESULTAT_KILDE")
//@AttributeOverrides({
//        @AttributeOverride(name = "code", column = @Column(name = "K_RESULTAT_KILDE")),
...
public class ResultatKildeCti extends CodesTablePeriodicItem<ResultatKildeCode, String> {
