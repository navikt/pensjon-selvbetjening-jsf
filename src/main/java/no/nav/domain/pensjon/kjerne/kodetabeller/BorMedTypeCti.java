...
//@Entity
//@Immutable
//@Table(name = "T_K_BOR_MED_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_BOR_MED_T")),
...
public class BorMedTypeCti extends CodesTablePeriodicItem<BorMedTypeCode, String> {
    private static final long serialVersionUID = 2182873760544414451L;

//    @ManyToOne
//    @org.hibernate.annotations.Fetch(org.hibernate.annotations.FetchMode.SELECT)
//    @JoinColumn(name = "K_GRNL_ROLLE_T")
    private GrunnlagsrolleCti grunnrolle;

    /**
     * @return the grunnrolle
     */
    public GrunnlagsrolleCti getGrunnrolle() {
        return grunnrolle;
    }
}
