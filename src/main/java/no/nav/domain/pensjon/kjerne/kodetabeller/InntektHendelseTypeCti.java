...
/**
 * CodesTableItem for InntektHendelseTypeCti
...
//@Entity
//@Immutable
//@Table(name = "T_K_INNTEKT_HENDELSE_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_INNTEKT_HENDELSE_T")),
...
public class InntektHendelseTypeCti extends CodesTablePeriodicItem<InntektHendelseTypeCode, String> {
    private static final long serialVersionUID = -8648336217602716377L;

//    @Column(name = "K_HENDELSE_T_FK", nullable = false)
