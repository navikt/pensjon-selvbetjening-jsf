...
//@Entity
//@Immutable
//@Table(name = "T_K_KJONN")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_KJONN")),
...
public class KjonnCti extends CodesTablePeriodicItem<KjonnCode, String> {
    private static final long serialVersionUID = 7643502936085287529L;
}
