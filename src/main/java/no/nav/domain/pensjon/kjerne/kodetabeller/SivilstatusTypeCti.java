...
//@Entity
//@Immutable
//@Table(name = "T_K_SIVILSTATUS_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_SIVILSTATUS_T")),
...
public class SivilstatusTypeCti extends CodesTablePeriodicItem<SivilstatusTypeCode, String> {
