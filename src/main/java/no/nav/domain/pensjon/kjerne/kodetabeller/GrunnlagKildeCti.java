...
//@Entity
//@Immutable
//@Table(name = "T_K_GRUNNLAG_KILDE")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_GRUNNLAG_KILDE")),
...
public class GrunnlagKildeCti extends CodesTablePeriodicItem<GrunnlagKildeCode, String> {
