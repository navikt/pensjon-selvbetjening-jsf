...
//@Entity
//@Immutable
//@Table(name = "T_K_UFORE_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_UFORE_T")),
...
public class UforeTypeCti extends CodesTablePeriodicItem<UforeTypeCode, String> {
