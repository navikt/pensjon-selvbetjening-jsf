...
//@Entity
//@Immutable
//@Table(name = "T_K_ADR_T_PERSON")
//@AttributeOverrides({
//        @AttributeOverride(name = "code", column = @Column(name = "K_ADR_T_PERSON")),
...
public class AdresseTypePersonCti extends CodesTablePeriodicItem<AdresseTypePersonCode, String> {
    private static final long serialVersionUID = -1156056209308216303L;
}
