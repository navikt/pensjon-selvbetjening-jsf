...
//@Entity
//@Immutable
//@Table(name = "T_K_REGELVERK_T")
//@AttributeOverrides({
//        @AttributeOverride(name = "code", column = @Column(name = "K_REGELVERK_T")),
...
public class RegelverkTypeCti extends CodesTablePeriodicItem<RegelverkTypeCode, String> {
    private static final long serialVersionUID = 8709973889143703021L;
}
