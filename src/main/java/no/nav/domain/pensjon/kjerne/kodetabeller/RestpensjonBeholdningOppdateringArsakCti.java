...
//@Entity
//@Immutable
//@Table(name = "T_K_REST_BEH_ARSAK")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_REST_BEH_ARSAK_T")),
...
public class RestpensjonBeholdningOppdateringArsakCti extends CodesTablePeriodicItem<RestpensjonBeholdningOppdateringArsakCode, String> {

    private static final long serialVersionUID = 5049914401031578331L;
}
