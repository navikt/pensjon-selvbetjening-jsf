...
public class BeregningMetodeCti extends CodesTablePeriodicItem<BeregningMetodeCode, String> {

    private static final long serialVersionUID = -8230003077269744644L;
}
