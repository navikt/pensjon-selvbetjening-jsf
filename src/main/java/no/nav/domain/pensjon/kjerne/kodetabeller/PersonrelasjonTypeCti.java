...
//@Entity
//@Immutable
//@Table(name = "T_K_PERSON_REL_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_PERSON_REL_T")),
...
public class PersonrelasjonTypeCti extends CodesTablePeriodicItem<PersonrelasjonTypeCode, String> {
