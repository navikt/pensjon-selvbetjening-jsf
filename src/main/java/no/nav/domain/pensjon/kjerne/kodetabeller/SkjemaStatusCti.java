...
//@Entity
//@Immutable
//@Table(name = "T_K_SKJEMA_PSELV_S")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_SKJEMA_PSELV_S")),
...
public class SkjemaStatusCti extends CodesTablePeriodicItem<SkjemaStatusCode, String> {
