...
//@Entity
//@Immutable
//@Table(name = "T_K_FORMELKODE")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_FORMELKODE")),
...
public class FormelKodeCti extends CodesTablePeriodicItem<FormelKodeCode, String> {

    private static final long serialVersionUID = 4912897622839257620L;
}
