...
//@Entity
//@Immutable
//@Table(name = "T_K_SPES_REG")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_SPES_REG")),
...
public class SpesialRegisteringCti extends CodesTablePeriodicItem<SpesialRegisteringCode, String> {

    private static final long serialVersionUID = 6364927485079816305L;
}
