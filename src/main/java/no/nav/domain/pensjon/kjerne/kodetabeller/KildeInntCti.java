...
/**
 * CodesTableItem for KildeInntCti
 * Table-mapping for the overwritten constructor of the super class.
 *
 */
//@Entity
//@Immutable
//@Table(name = "T_K_KILDE_INNT_T")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_KILDE_INNT_T")),
...
public class KildeInntCti extends CodesTablePeriodicItem<KildeInntCode, String> {
