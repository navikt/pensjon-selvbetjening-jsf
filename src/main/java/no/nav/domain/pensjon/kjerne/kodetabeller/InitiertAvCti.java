...
//@Entity
//@Immutable
//@Table(name = "T_K_INITIERT_AV")
//@AttributeOverrides({@AttributeOverride(name = "code", column = @Column(name = "K_INITIERT_AV")),
...
public class InitiertAvCti extends CodesTablePeriodicItem<InitiertAvCode, String> {
    private static final long serialVersionUID = 3678379370971483165L;
}
